...
export default function LinkButton(props: LinkButtonProps) {
    ...
    return (
        <a href={props.href} className="flex items-center justify-center  text-base font-medium outline outline-1 outline-gray-600 dark:outline-gray-300 text-gray-900 dark:text-gray-100 px-4 py-2 rounded-full"
        >
