...
export const Header = () => {
  return (
    <header className="sticky top-0 left-0 z-header flex w-full border-gray-300 border-b bg-header_background/70 backdrop-blur-sm dark:border-gray-800/70 dark:bg-header_background-dark/70 dark:backdrop-blur-sm">
