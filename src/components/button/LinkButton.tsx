...
export default function LinkButton(props: LinkButtonProps) {
    ...
    return (
        <a href={props.href} className="flex items-center justify-center  rounded-lg border border-gray-600 px-4 py-2 text-base font-medium text-grayishblack dark:border-gray-500 dark:text-grayishblack-dark" >
